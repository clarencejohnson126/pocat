              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      id="name"
                      required
                      className="bg-black focus:ring-[#00c278] focus:border-[#00c278] block w-full sm:text-sm border-[#00c278]/20 rounded-md text-white"
                      value={formData.name}
                ...
                <div>
                  <button
                    ...
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#00c278] hover:bg-[#00c278]/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00c278] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
          ...
          >
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-white hover:text-[#00c278] transition-colors">
